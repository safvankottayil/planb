...
function Navbar() {
  ...
  return (
    <div className='flex justify-between items-center  dark:bg-black z-10 md:pl-4 fixed w-full '>
      ...
      />
      <div className={`${show?'border-l-2 w-4/5':'w-0'} transition-all duration-500 bg-black flex overflow-hidden flex-col md:flex-row h-screen md:h-fit top-0 right-0 fixed pt-5 md:pt-0  flex-grow md:items-center md:justify-end md:pr-10`} >
